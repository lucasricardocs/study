...
def display_cronometro():
    ...
    if st.session_state.estudo_ativo and st.session_state.hora_inicio:
        while st.session_state.estudo_ativo:
            ...
            cronometro_placeholder.markdown(f"""
                <div style="background-color: black; color: white; padding: 20px; border-radius: 10px; font-size: 4em; text-align: center; font-family: 'Courier New', monospace; font-weight: bold;">
                    00:00:00
                </div>
            """, unsafe_allow_html=True)
    else:
